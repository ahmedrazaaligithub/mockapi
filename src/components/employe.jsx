...
const EmployeeForm = () => {
    ...
    async function handleSubmit() {
        try {
            let axios_response = await axios.post("https://67b416df392f4aa94fa93d91.mockapi.io/employee", {
                employee_name: name,
    ...
    return (
        <div className="flex justify-between items-center min-h-screen bg-gray-100">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                ...
                <h2 className="text-center text-2xl font-semibold text-gray-700">Employees Information</h2>
